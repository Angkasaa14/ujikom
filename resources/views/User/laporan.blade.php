            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav text-center ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link ml-3 text-white" href="{{ route('pekat.logout') }}"onclick="return confirm('Apakah Anda Yakin ingin Keluar?')"
        ...
        <div class="col-lg-8 col-md-12 col-sm-12 col-12 col">
            <div class="content content-top shadow">
                ...
                <form action="{{ route('pekat.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn btn-custom mt-2" onclick="return confirm('Apakah anda sudah yakinn??')">Kirim</button>
                </form>
            </div>
        </div>
    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-8">
            ...
            <div class="laporan-bottom">
                @if ($v->foto != null)  
                <img src="{{ asset('storage/'.$v->foto) }}" alt="{{ 'Gambar '.$v->judul_laporan }}" class="gambar-lampiran">
                @endif
                @if ($v->tanggapan != null)
